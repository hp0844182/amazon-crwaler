...
export default class SessionCheerioCrawler extends Apify.CheerioCrawler {
    constructor(options) {
        super(options);
        this.sessions = {};
    ...
    _getRequestOptions(request) {
        console.log('shfkhsfhkjashfkjhsakjfhkashkfh')
        log.info("啊啊师傅阿萨发阿萨方式阿飞啊师傅")
    ...
    _getProxyUrl(proxySession, request) {
        ...
        log.info("是否使用"+this.useApifyProxy)
